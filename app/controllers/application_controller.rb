...
class ApplicationController < ActionController::Base
  ...
  protect_from_forgery  :except => [:do_the_upload_multi]  # protect against site forgery
  ...
  def folder_id
    ...
    when 'folder/edit', 'folder/update', 'folder/destroy'
      #current_folder_id = @folder.parent_id if @folder # changing  in 0.6.9, this forced users to have the same permissions in parent folder than the folder they're accessing. 
      current_folder_id = @folder.id 
    when 'file/download', 'file/edit', 'file/update', 'file/destroy', 'file/preview'
